...
# print(e)
#
# a = [['C','э','e','л','е'], ['э','п','ш','а','н'], ['д','р','и','м','я']]
# b = []
...
# print(b)
#
# z = [12,42,64,24,'Выбери меня',124,1,754,14]
# a = [0,1,2]
# b = [0,1,2,3]
# c = [0,1,2,3,4]
# d = [0,1,2,3,4,5]
...
#записать csv файл с разными названиями в одном цикле.
...
#     if count == 0:
#         a = ['Я пойду первым']
#         with open(f"data{count}.csv", "w", encoding="utf-8") as file:
#             writer = csv.writer(file, delimiter=",", lineterminator='\n')
#             writer.writerow(a)
#             count += 1
#     elif count == 1:
